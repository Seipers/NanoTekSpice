...
{
	this->_link.at(2) = new XorLink(this, 1, this, 2);
	this->_link.at(3) = new XorLink(this, 5, this, 6);
	this->_link.at(9) = new XorLink(this, 8, this, 9);
	this->_link.at(10) = new XorLink(this, 12, this, 13);
}
...
void	C4030::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
	...
	else if (pin_num_this == 3 || pin_num_this == 4 || pin_num_this == 10 || pin_num_this == 11) // Boucle inf :|
		component.SetLink(pin_num_target, *this, pin_num_this);
}

void	C4030::Dump() const
{
	std::cout << "4030: " << this->_name << std::endl;
}