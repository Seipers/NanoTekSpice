//
// XorGate.cpp for nano in /home/sebastien/Rendu/cpp_nanotekspice/component
//
...
{
	this->_link.at(0) = new XorLink(this, 3, this, 2);
}
...
nts::Tristate XorGate::Compute(size_t pin_num_this)
{
...
void	XorGate::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
...
{
	std::cout << "XorGate: " << this->_name << std::endl;
}