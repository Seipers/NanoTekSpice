...
{
	this->_link.at(0) = new NorLink(this, 3, this, 2);
}
...
nts::Tristate NorGate::Compute(size_t pin_num_this)
{
...
void	NorGate::SetLink(size_t pin_num_this, nts::IComponent &component, size_t pin_num_target)
{
...
{
	std::cout << "NorGate: " << this->_name << std::endl;
}