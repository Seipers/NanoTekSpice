...
{
	this->_link.at(2) = new OrLink(this, 1, this, 2);
	this->_link.at(3) = new OrLink(this, 5, this, 6);
	this->_link.at(9) = new OrLink(this, 8, this, 9);
	this->_link.at(10) = new OrLink(this, 12, this, 13);
}
...
{
	std::cout << "4071: " << this->_name << std::endl;
}